...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value=''
        Entry(master,width=20,bg='black',fg='white',font=('Arial Bold',32),textvariable=self.equation).place(x=0,y=0)

        Button(width=11,height=4,text='%',relief='flat',bg='#f8f8ff',command=lambda:self.show('%')).place(x=0 ,y=50)
